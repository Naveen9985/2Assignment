...
public class TripAdvisor extends BaseClass{
    public static void 	openTripAdvisor() throws Exception {
   	...
   	WebElement ele1 = driver.findElement(By.xpath("//div[@class = 'brand-global-nav-action-search-Search__searchButton--b9-IK']"));
	...
	//((JavascriptExecutor)driver).executeScript("argumnets[0].scrollIntoView().click()", ele);
     ...
     /*String hotelRatings=(driver.findElement(By.xpath("//div[@class='labelHeader']")).getText());
     System.out.println(hotelRatings);
     if(hotelRatings.matches("Hotel Ratings")) {*/
